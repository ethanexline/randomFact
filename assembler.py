...
def returnFact():
    ...
    fact = '* gravy, * sauce, * syrup, * concentrate, *CCMan, *CCLand' # test fact
    ...
    or fact.find("!!") != -1 or fact.find("??") != -1):
        ...
        if fact.find("|") != -1:
            if fact.find("|CC") != -1:
                fact = fact.replace("|CC", utility.getRand(lists.concepts).capitalize(), 1)
            else:
        ...
        if fact.find("%%") != -1:
            fact = fact.replace("%%", utility.getRand(lists.parties), 1)
        ...
        if fact.find("$") != -1:
            ...
            if fact.find("$CC") != -1:
                ...
                fact = fact.replace("$", utility.getRand(lists.parts), 1)

        if fact.find("~") != -1:
            fact = fact.replace("~", utility.getRand(disease), 1)
        ...
        if fact.find("*") != -1:
            if fact.find("*CCMan") != -1:
                ...
                if replacement.find("=") != -1:
                    ...
                    fact = fact.replace("*CCMan", replacement.title().replace(" ", "").replace("'", "").replace("-", "") + "Man", 1)
            elif fact.find("*CCLand") != -1 or fact.find("*CCFlavoredLand") != -1:
                replacement = utility.getRand(lists.foods)
        ...
        if fact.find("!!") != -1:
            fact = fact.replace("!!", utility.getRand(lists.teams), 1)

        if fact.find("??") != -1:
            if fact.find("??CC") != -1:
                fact = fact.replace("??CC", utility.getRand(lists.interjection).capitalize(), 1)
            else:
