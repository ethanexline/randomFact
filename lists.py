...
"began a club that focuses on", "conquered QQ intense fear of", "felt a pang of | while mourning the loss of", "peeled the plastic off of a fresh container of", "vomited out",
"threw a hissy fit over", "completely ran out of", "mulled over the idea of", "considered the consequences of endorsing", "gambled away QQ entire supply of", "vomited on",
"publicly denounced", "called out @ over QQ prejudice towards", 'debuted QQ new movie called \"%%CC\", starring', "did voice acting for a game where you play as",
...
"butt", "immortality", "|", "=s", "= enthusiasts", "QQ $", "the $ of a =", " a = with & extra $s", "^ pants", "QQ VV wearing a \"@\" costume", "QQ VV", "a ^ case of ~",
"@\'s VV\'s favorite VV", "QQ VV riding a =", "^ chicken nuggets", utility.madeUpWord(False), "a ^ PR campaign", "~", "the asteroid belt", "@\'s pet =", "the sun", "the moon",
...
"a plastic surgeon specializing in $s", "a vet specializing in =s", "a $ surgeon", "mankind", "humanity", "the space-time continuum", "& dollars", "& cents"]
...
"iron", "bronzen", "flaxen", "golden", "rock-hard", "titanium", utility.madeUpWord(False), "moderate", "impressive", "successful", "unsuccessful", "hypothetical", "insufficient",
...
"economics", "semantics", "sadness", "grief", "sorrow", "despair", "heat", "ice", "anger", "purpose", "*", "law", "order", "justice"]
...
", which sparked @'s interest in |.", ", which should fill you with |.", ". --@", ", which is how @ contracted ~.", " - ??!", " - ???", ", you ^ =!", ", you ^ sack of *!",
", after which QQ $ fell off.", ", which is probably QQ best work.", ", which is a real slap in the $.", ' - well, "??" to you too!', " - ??, ??.", " - ??, ??!",
", which happens to be the backstory for my new character, *CCMan.", " - but what about !!!?", ", which, for !!!, was ^ly ^.", " with & sacks of * in QQ $.", ", you ='s VV!",
", you ^ piece of *!", ". D:", ". :3", ". :(", ". B)", ". <3"]
...
"Tony the =CC", "=CC Sam", "the Trix =CC", "John Mayer", "Elvis", "the Prince of |CC", "the Prince of *CC", "Mario", "Luigi", "Waluigi", "QQ favorite =", "Benedict Cumberbatch",
...
"the Princess of |CC", "Pooh", "Ysgramor", "Alduin", "Paarthurnax", "the Grinch", "Santa Claus", "Hideo Kojima", "Hidetaka Miyazaki", "Mark Zuckerberg", "Todd Howard"]

places = ["^CC Jersey", "the ^CC States", "Europe", "Russia", "Asia", "Japan", "yo VV's house", "the sock drawer", "Madagascar", "Californ-I-A", "QQ soul", 
...
"^CC York", "^CC Delhi", "Stonehenge", "VV's basement", "the Pacific Ocean", "the Statue of Liberty", utility.madeUpWord(True), "the $ of a =", "Delfino Plaza", "the 90s",
